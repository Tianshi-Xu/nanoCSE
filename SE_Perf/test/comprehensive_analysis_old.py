...
class TrajPoolExtractor:
    ...
    def _get_trajectory_files(self) -> list[tuple[Path, Path, int]]:
        ...
        for instance_dir in output_dir.iterdir():
            ...
            run_dirs = [d for d in instance_dir.iterdir() if d.is_dir() and d.name.isdigit()]
    ...
    def _create_yaml_content(self, comprehensive_analysis: str) -> str:
        ...
        yaml_content = {"agent": {"templates": {"system_template": full_content}}}
    ...
    def extract_pool_insights(self) -> None:
        ...
        for instance_dir, trajectory_file, run_number in trajectory_files:
            try:
                ...
                comprehensive_analysis = self._analyze_all_approaches(problem_statement, all_approaches)
...
def main():
    ...
    parser.add_argument(
        "config", nargs="?", default="Aeon/configs/test_claude.yaml", help="Path to configuration YAML file"
    )
