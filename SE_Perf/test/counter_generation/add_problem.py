...
def update_filtered_predictions(
    filtered_predictions_path: str, problem_statements: dict[str, str], output_path: str = None
) -> None:
    """
    ...
    with open(filtered_predictions_path, encoding="utf-8") as f:
...
def main():
    ...
    parser.add_argument("--split", default="test", choices=["dev", "test"], help="SWE-bench数据集分割 (默认: test)")
